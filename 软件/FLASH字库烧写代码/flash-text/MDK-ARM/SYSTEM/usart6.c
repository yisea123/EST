...
void usart6_init(u32 bound){
  ...
  GPIO_InitTypeDef GPIO_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOG,ENABLE); //使能GPIOC、GPIOD时钟
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_USART6,ENABLE);//使能USART6时钟
 
	//串口1对应引脚复用映射
	GPIO_PinAFConfig(GPIOG,GPIO_PinSource9,GPIO_AF_USART6); //GPIOC12复用为USART6
	GPIO_PinAFConfig(GPIOG,GPIO_PinSource14,GPIO_AF_USART6); //GPIOD2复用为USART6
...
//开启一次 DMA 传输
//DMA_Streamx:DMA 数据流,DMA2_Stream1~7/DMA2_Stream0~7
//ndtr:数据传输量
