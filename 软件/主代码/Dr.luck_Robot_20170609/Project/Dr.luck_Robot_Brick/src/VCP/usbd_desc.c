...
//#define USBD _PRODUCT_HS_STRING          "STM32 Virtual ComPort in HS mode"
...
#define USBD_PRODUCT_HS_STRING        "Custom in HS mode"
#define USBD_SERIALNUMBER_HS_STRING   "00000000011B"

#define USBD_PRODUCT_FS_STRING        "EST"
