...
// #ifdef USE_USB_OTG_FS  虚拟串口只是用otg1
...
//  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_OUT;//输入功能
//  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL; 
...
void USB_OTG_BSP_EnableInterrupt(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  NVIC_InitStructure2.NVIC_IRQChannel = OTG_HS_IRQn;  
  NVIC_InitStructure2.NVIC_IRQChannelPreemptionPriority = 1;
  NVIC_InitStructure2.NVIC_IRQChannelSubPriority = 3;		//3
