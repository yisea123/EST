...
//	pbuf[10] = ((uint8_t)(0x5740 & 0x00FF));
//	pbuf[11] = ((uint8_t)((0x5740 & 0xFF00) >>8));
...
//	{
//		for(i=0; i<USB_Rx_Cnt; i++)	//寻找开始符
//		{
//			if(*(USB_Rx_Buffer + i) == 0x68) //接收到开始符
//			{
//				Receive_start = 1;
//				USB_TimePic = 1000; //接收时间计时
//				break;		//跳转后i不会自加1
//			}
//		}
//	}
//	if(Receive_start)
//	{
//		if(!USB_Rx_Length)	//第一段数据
//			for(; i<USB_Rx_Cnt; i++) 
//				USB_Rx_Buff[USB_Rx_Length++] = *(USB_Rx_Buffer + i); 
//		else 	//其余段数据
