...
/** @defgroup USBH_HID_CORE_Exported_FunctionsPrototype
  * @{
  */ 
extern uint8_t reportBuff[64];
extern int reportLen;
extern u8 HostComConnected ;
void USBH_SendDataProcess(USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost, uint8_t reportBuff[], int *reportLen);
extern u8 USBH_SendData(uint8_t DataBuff[], int DataLen);
...
USBH_Status USBH_Set_Report (USB_OTG_CORE_HANDLE *pdev,
                             USBH_HOST *phost,
                                  ...
                                  uint8_t reportLen,
                                  uint8_t* reportBuff);
USBH_Status USBH_SendHalfWord(USB_OTG_CORE_HANDLE *pdev, USBH_HOST *phost, uint8_t reportBuff[8]);
/**
  * @}
  */ 
