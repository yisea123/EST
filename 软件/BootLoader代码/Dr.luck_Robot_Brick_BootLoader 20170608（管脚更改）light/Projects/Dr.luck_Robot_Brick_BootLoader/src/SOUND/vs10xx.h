/**
  ******************************************************************************
  * @file    EV3 Brick of Dr.luck/vx10xx.h 
...
#ifdef  VS10XX_GLOBALS
#define VS10XX_EXT 
#else   
#define VS10XX_EXT    extern
#endif

#include "sys.h"

extern u8 Sys_Tick2ms_Flag;
//////////////////////////////////////////////////////////////
#define VS_DQ       PAin(8)  	//DREQ PG4
#define VS_RST      PDout(15) 	//RST  PA8
#define VS_XCS      PAout(4)  	//XCS  PA4
#define VS_XDCS     PGout(4)  	//XDCS PG2
//////////////////////////////////////////////////////////////
...
VS10XX_EXT _vs10xx_obj vsset;		//VS10XX设置
...
#define	XCS_1()			(GPIOA->ODR|=GPIO_Pin_4)
#define	XCS_0()			(GPIOA->ODR&=~GPIO_Pin_4)
#define	XDCS_1()		(GPIOG->ODR|=GPIO_Pin_4)
#define	XDCS_0()		(GPIOG->ODR&=~GPIO_Pin_4)
#define	XRESET_1()		(GPIOD->ODR|=GPIO_Pin_15)
#define	XRESET_0()		(GPIOD->ODR&=~GPIO_Pin_15)

#define	SDAT_1()		(GPIOC->ODR|=GPIO_Pin_12)
#define	SDAT_0()		(GPIOC->ODR&=~GPIO_Pin_12)
#define	SCLK_1()		(GPIOC->ODR|=GPIO_Pin_10)
#define	SCLK_0()		(GPIOC->ODR&=~GPIO_Pin_10)

#define	DREQ()			(GPIOA->IDR&GPIO_Pin_8)

VS10XX_EXT void Mp3Reset(void);
VS10XX_EXT void send_dat(unsigned char dat);
VS10XX_EXT u8 flush_buffer(void);
VS10XX_EXT void Mp3_GPIO_Init(void);
